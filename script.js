    ...
    colorDots.forEach(dot => {
        dot.addEventListener('click', () => {
            ...
            if (parentTab) {
                ...
                const colorDisplay = parentTab.querySelector('.color-name-display span');
                if (colorDisplay) {
    ...
    forms.forEach(form => {
        form.addEventListener('submit', (e) => {
            ...
            const formData = {
                ...
                model: form.querySelector('select') ? form.querySelector('select').value : 'General Request',
                source: window.location.pathname.includes('spb') ? 'SPb (Wagner-Auto)' : 'Moscow (Autoretail)'
            };
